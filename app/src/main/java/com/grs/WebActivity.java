...
//        String url = getIntent().getStringExtra("URL");
        String id = XmlUtil.getXmlAppId(this);

        String url = "file:///android_asset/apps/"+id+"/www/index.html";
        Log.e(TAG,"(WebActivity.java:62) "+url);
...
//        webView.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
        ...
        mAgentWeb.getWebCreator().getWebView().setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String js = "window.localStorage.getItem('token');";
